    ...
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <p>
          ...
          Ballard! Furnishing the place on my own became an existential experience quite quickly. At one point I legitimately asked myself: 
          "What rug best represents me as a person?" 💀
        </p>

        <p>
          The problem was infinite choice: an endless scroll of patterns, designs, and swatches. At the outset I frequently interrupted my 
          West Elm catalogue browsing with viewings of the <Link href="https://www.youtube.com/watch?v=exL51n3py6g" target="_blank">IKEA scene</Link> in 
